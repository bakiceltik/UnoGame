...
public class ConsoleUI {
    ...
    private void displayScores() {
        ...
        System.out.println(
                "Number of cards in the trash pile: " + ANSI_BOLD + gameManager.getDiscardPileCount() + ANSI_RESET);
    ...
    private void printWelcomeMessage() {
        ...
        System.out.println(
                " - " + ANSI_BOLD + "Draw Two" + ANSI_RESET + ": Next player draws 2 cards and loses their turn");
        ...
        System.out.println(
                " - " + ANSI_BOLD + "Wild Draw Four" + ANSI_RESET + ": Declare a color, next player draws 4 cards");
        System.out.println(
                " - " + ANSI_BOLD + "Shuffle Hands" + ANSI_RESET + ": All hands are shuffled and redistributed");
    ...
    private void displayGameState() {
        ...
        if (topCard != null) {
            ...
            Color currentColor = gameManager.getCurrentColor();
            System.out.println("Current active color: " + formatColor(currentColor));
        } else {
            System.out.println("No card has been opened yet.");
        }

        // Deste ve çöp destesi durumunu göster
        System.out.println("Number of cards remaining in the deck: " + ANSI_BOLD + gameManager.getRemainingCardCount()
                + ANSI_RESET);
        System.out.println(
                "Number of cards in the trash pile: " + ANSI_BOLD + gameManager.getDiscardPileCount() + ANSI_RESET);
    ...
    private void displayGameResults() {
        ...
        System.out.println(ANSI_YELLOW + ANSI_BOLD + "WİNNER: " + winner.getName() + " (Total score: "
                + winner.getTotalScore() + ")" + ANSI_RESET);

        System.out.println("\nAll Players:");
        List<Player> players = gameManager.getPlayers();
        for (Player player : players) {
            if (player == winner) {
                System.out.println(ANSI_GREEN + "  " + player.getName() + ": " + player.getTotalScore() + " points"
                        + ANSI_RESET + " 🏆");
            } else {
